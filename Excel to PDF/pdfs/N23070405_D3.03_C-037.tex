        ...
        %%% FOOTER %%%
            ...
            \multicolumn{2}{c}{VINOD KUMAR TANWAR} & \multicolumn{2}{c}{VED VARUN AGRAWAL} & \multicolumn{2}{c}{Dr. RAJESH} \\[1.5 ex]
            \\
...
(-182.8 to -582.4) \si{mV}  \textpm  1.5 \si{mV} (k=2.32) ;  \\
(215.8 to 2207) \si{mV}  \textpm  (1.5 to 2.0) \si{mV} (k=2.02 to 2.32);  \\
Time (sec): (19.994  \textpm  1 x 10-3) \si{µs} (k=2) \\
...
(19.0009  \textpm  0.0003) \si{\textohm} (k=2) \\
4. Defibrillator (Model No.: TEC5621; S. No.: 01273; \\
Make: Nihon Kohden); \\
(9.5  \textpm  0.1) \si{J} (k=2.16) \\
(19.3  \textpm  0.1) \si{J} (k=2.00) \\
(48.2  \textpm  0.2) \si{J} (k=2.13) \\
(97.1  \textpm  0.3) \si{J} (k=2.00) \\
(146.1  \textpm  0.5) \si{J} (k=2.06) \\
(259.5  \textpm  0.8) \si{J} (k=2.05)} \end{minipage}\\
...
\end{longtable}
        ...
        The expanded uncertainty in wavelength measurement at NPL. is  \textpm 0.5 m. \\
