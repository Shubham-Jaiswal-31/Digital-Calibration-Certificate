        ...
        \multicolumn{2}{c}{} & \multicolumn{2}{c}{} & \multicolumn{2}{c}{} \\[1.5 ex]
        \\
...
Date: XXXXX} \\
        \stepcounter{rownum}\arabic{rownum}. 	&	\makecell[lt]{Description and Identification \\of Item under Calibration}  &:&	\parbox[t]{7.8cm}{ \raggedright 5 \si{kg} to 1 \si{g} (20 Nos.) : Inte\si{g}ral knob bronze wei\si{g}hts. \\
500 \si{mg} to 1 \si{mg} (12 Nos.) : Stainless steel wire wei\si{g}hts. \\
Assumed Density (d)  : (8400  \textpm  150) \si{kg}/cm3   k=2 \\
Assumed Density (d)  : (7950  \textpm  150) \si{kg}/cm3   k=2 \\
Make : XXXX \\
Model No. : XXXX \\
Serial No. : XXXXX \\
Box Id. No. : XXXX} \\
